...
const styles = StyleSheet.create({
  ...
  inputWrapper: { height: 45, width: '90%', borderRadius: 5,borderColor: '#E4E4E4', borderWidth: 1,backgroundColor: '#FAF9F9', marginBottom: 10,    padding: 10,  },
...
{  state = {    loading: false,  };
  ...
  _onLoginFbPress = async () => { this.setState({ loading: true });

    let res;
    try {  res = await LoginManager.logInWithReadPermissions([ 'public_profile','email',]); } 
    catch (error) 
    { console.log('====================================');
